...
- Threshold adjustment to 0.35 improved recall without retraining (60.0%)
...
| Chart | Description |
|---|---|
| `images/customer_churn_class_distribution.png` | Class imbalance (79.6% / 20.4%) |
...
| `images/precision_vs_recall_tradeoff_across_thresholds.png` | Score vs threshold |
| `images/precision_recall_tradeoff_decision_thresholds_default_gbm.png` | Precision–Recall scatter |
| `images/recall_improvement_gbm_mitigation_approaches.png` | 4 GBM variants compared |
| `images/model_leaderboard_accuracy_vs_recall_catch_rate.png` | All 6 models leaderboard |

## Limitations & Next Steps

- **Class imbalance:** Dataset is ~80/20. SMOTE + threshold tuning pushes churner recall to ~66% — further improvement requires richer features
...
**Aayush Yagol | Data Analyst, Canberra ACT**

Canberra-based data professional with a Master's in Information Technology and IBM Data Analyst certification, specialising in insurance and risk analytics. Portfolio: [aayushyagol.com](https://aayushyagol.com)
